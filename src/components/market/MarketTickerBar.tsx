...
export default function MarketTickerBar() {
  ...
  return (
    <div className="ticker-shell sticky top-16 z-40 w-full border-b border-gray-200 bg-white/95 backdrop-blur">
      <div className="ticker-inner w-full overflow-hidden py-2">
