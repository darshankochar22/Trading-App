...
import StrategyLabPanel from "@/components/quant/StrategyLabPanel";
      ...
      <AppContainer as="main" className="max-w-7xl py-10">
        <section className="app-card-elevated rounded-3xl bg-zinc-950 p-8 text-white">
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-zinc-300">Quant Module 01</p>
              <h1 className="app-display mt-3 text-5xl text-white">Strategy Lab</h1>
              <p className="mt-3 max-w-2xl text-sm text-zinc-300">
                Run parameterized SMA crossover tests on live crypto historical data, inspect
                drawdowns, and review trade-level output.
              </p>
            </div>
